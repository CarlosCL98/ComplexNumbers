...
public class MathComplexException extends Exception {
    ...
    public static final String MULTIPLICACION_DIMENSION_MATRICES_DIFERENTE = "La dimensión de las columnas de la matriz m1 debe ser igual a la dimensión de las filas de la matriz m2 para multiplicarlas.";
    public static final String ACCION_DIMENSION_MATRIZ_VECTOR_DIFERENTE = "La dimensión de las columnas de la matriz m1 debe ser igual a la dimensión de las filas del vector para realizar la acción.";
    public static final String MATRIZ_NO_ES_CUADRADA = "La matriz debe ser cuadrada para realizar esta operación";
