...
public class MathComplexTest extends TestCase {
    ...
    public void testDeberiaSumarDosNumeroComplejos1() {
        ...
        ComplexNumber result = MathComplex.sumarNumerosComplejos(c1, c2);
        ComplexNumber resultToCompare = new ComplexNumber(8, 8);
        assertTrue(resultToCompare.equals(result));
    }
    ...
    public void testDeberiaRestarDosNumeroComplejos1() {
        ...
        ComplexNumber result = MathComplex.restarNumerosComplejos(c1, c2);
    ...
    public void testDeberiaMultiplicarDosNumeroComplejos1() {
        ...
        ComplexNumber result = MathComplex.multiplicarNumerosComplejos(c1, c2);
    ...
    public void testNoDeberiaDividirDosNumeroComplejosSiElDenominadorEsCero() {
        ...
        ComplexNumber c2 = new ComplexNumber(0, 0);
        try {
            ComplexNumber result = MathComplex.dividirNumerosComplejos(c1, c2);
    ...
    public void testDeberiaDividirDosNumeroComplejos1() {
        ...
        try {
            result = MathComplex.dividirNumerosComplejos(c1, c2);
        } catch (MathComplexException e) {
    ...
    public void testDeberiaSumarDosVectoresDeComplejos() {
        ...
        try {
            ComplexNumber[] result = MathComplex.sumarVectoresComplejos(v1, v2);
            assertTrue(true);
        } catch (MathComplexException e) {
            System.out.println(e.getMessage());
        }        
